...
#    (r'^accounts/login/$', 'django.contrib.auth.views.login'),
    ...
    url(r'^addCourseStandards/$', 'LessonPlanner.views.addCourseStandards', name="addCourseStandards"),
    ...
    (r'^requestCourseStandards/$', 'LessonPlanner.views.requestCourseStandards'),
